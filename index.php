...
<body>
	<table width="1000" height="600" align="center" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td colspan="5" height="100" align="center" bgcolor="#CCCCCC">ÜST ALAN (HEADER ALANI)</td>
		</tr>
		<tr>
			<td colspan="5" height="20">&nbsp;</td>
		</tr>
		<tr>
			<td width="200" valign="center" align="center" height="400" bgcolor="#AAAAAA"><a href="index.php" style="text-decoration: none; color: white;">Ana Sayfa</a></td>
			<td width="10" height="400">&nbsp;</td>
			<td width="480" height="400" align="center" bgcolor="#CCCCCC">İÇERİK ALANI (MAIN ALANI)</td>
			<td width="10" height="400">&nbsp;</td>
			<td width="300" height="400" valign="top">
				<?php if(isset($_SESSION["Kullanici"])){ ?>
					<table width="300" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
							<td height="30" align="right"><a href="uyesilform.php" style="text-decoration: none; color: red;">Üyelik Sil</a></td>
						</tr>
                        <tr>
							<td height="30" align="right"><a href="uyeguncelleform.php" style="text-decoration: none; color: red;">Bilgileri Güncelle</a></td>
						</tr>
                        <tr>
							<td height="30" align="right"><a href="admin.php" style="text-decoration: none; color: red;">Admin Sayfasına Git</a></td>
						</tr>
						<tr>
					...
					<form action="uyegiris.php" method="post">
						<table width="300" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
								...
								<td height="30" width="10">:</td>
                                <td height="30" width="190"><select name="durum" style="width: 102%;">
		...
		<tr>
			<td colspan="5" height="100" align="center" bgcolor="#CCCCCC">ALT ALAN (FOOTER ALANI)</td>
		</tr>
	</table>
</body>
</html>
